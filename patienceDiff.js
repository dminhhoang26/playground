...
let a = 'Điểm đánh giá thường xuyên (1) - Học kỳ 1/ Single weight (1) - Semester 1'
let b = 'Điểm đánh giá thường xuyên (2) - Học kỳ 1/ Single weight (2) - Semester 1'
let original = 'Điểm đánh giá thường xuyên - Học kỳ 1/ Single weight - Semester 1'

console.log(patienceDiffPlus(original.split(' '), b.split(' ')))
